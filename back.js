//https://github.com/victorperin/transition-live-background
...
function atualizarGradiente(){
  ...
  //document.getElementById("author").style ="text-align:center"
  document.getElementById("author").style = "text-align:center;background:linear-gradient(left, "+color1+" 0%, "+color2+" 100%);background:-webkit-gradient(linear, left top, right top, from("+color1+"), to("+color2+"));background:-moz-linear-gradient(left, "+color1+" 0%, "+color2+" 100%);background:-o-linear-gradient(left, "+color1+" 0%, "+color2+" 100%);background:-ms-linear-gradient(left, "+color1+" 0%, "+color2+" 100%);";
